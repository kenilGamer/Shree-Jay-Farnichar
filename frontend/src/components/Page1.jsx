  ...
  const features = [
    {
      ...
      description:
        "Handcrafted, luxurious furniture with a touch of artistry, adding elegance to any room.",
    },
    {
      ...
      description:
        "Timeless elegance with modern sophistication, designed to last a lifetime.",
    },
    {
      ...
      description:
        "Sleek and modern furniture that blends functionality with contemporary aesthetics.",
    },
    {
      ...
      description:
        "Eco-friendly furniture made from sustainable materials, promoting a greener lifestyle.",
    },
    {
      ...
      description:
        "Customizable furniture to meet your unique style and needs, ensuring a perfect fit.",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16 ">
          {features.map((feature, index) => (
            <div key={index} className="card-modern p-6 card-hover group">
        ...
        <div className="text-center slide-up">
          <div className="card-modern max-w-4xl mx-auto p-8">
            ...
            <p className="text-gray-300 mb-8 text-lg">
              Let our expert team create the perfect interior solution for your
              home or office.
            </p>
